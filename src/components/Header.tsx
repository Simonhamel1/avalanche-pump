          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="w-10 h-10 bg-gradient-to-br from-avalanche-red to-red-600 rounded-2xl flex items-center justify-center shadow-lg glow-icon">
          ...
          <nav className="hidden md:flex items-center space-x-2">
            <Link
              ...
              className={`flex items-center space-x-2 px-4 py-3 rounded-2xl text-sm font-bold transition-all duration-300 ${
                isActive('/') 
                  ? 'text-white bg-gradient-to-r from-avalanche-red to-red-600 shadow-lg glow-icon' 
          ...
          <div className="flex items-center space-x-3">
            {walletAddress ? (
              <div className="flex items-center space-x-3">
                {/* Network indicator */}
                {networkName && (
                  <div className={`px-3 py-2 rounded-2xl text-xs font-black border-2 ${
                    isAvalancheNetwork 
                      ? 'bg-green-500/20 text-green-400 border-green-500/50 glow-icon' 
                ...
                {/* Balance */}
                {walletBalance && (
                  <div className="bg-gray-800/80 backdrop-blur-xl px-4 py-2 rounded-2xl border border-gray-700/50">
                ...
                {/* Address */}
                <div className="bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-2 rounded-2xl shadow-lg">
                ...
                {!isAvalancheNetwork && onSwitchToAvalanche && (
                  <Button 
                    ...
                    className="neon-button bg-gradient-to-r from-orange-500 to-red-500 hover:from-red-500 hover:to-orange-500 text-white font-bold px-4 py-2 rounded-2xl"
                  >
              ...
              <Button 
                ...
                className="neon-button bg-gradient-to-r from-avalanche-red to-red-600 hover:from-red-600 hover:to-avalanche-red text-white font-black px-6 py-3 rounded-2xl transform hover:scale-105 transition-all duration-300"
              >
